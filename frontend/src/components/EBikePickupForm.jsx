            ...
            if (formData.userDetails.drivingLicense) {
                try {
                    const response = await fetch(
                        `/api/licenses/${formData.userDetails.drivingLicense}`
                    );
            ...
            setFormData((prevState) => ({
                ...
                userDetails: {
                    ...
                    phoneNumber:
                        ...
                        data.phoneNumber ||
                        prevState.userDetails.phoneNumber,
                    drivingLicense:
                        data.userDetails?.drivingLicense ||
                        data.drivingLicense ||
                        prevState.userDetails.drivingLicense,
                    address:
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="text-center">
                            <button
                                type="button"
                                onClick={() =>
                                    handleEntryMethodSelect("manual")
                                }
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg space-y-4">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-gray-900">
                                        {formData.userDetails.phoneNumber}
                                    </p>
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-600">
