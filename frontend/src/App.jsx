      ...
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <main className="flex-grow">
          <Routes>
            ...
            <Route path="/station/:stationId" element={<StationVehiclesPage />} />
            <Route path="/book/:vehicleId" element={<BookingPage />} />
            <Route path="/admin/pickup" element={<EBikePickupForm />} />
            <Route path="/admin/dropoff" element={<EBikeDropOffForm />} />
          </Routes>
        </main>
        <footer className="bg-gray-800 text-white py-8">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-3 gap-8">
              <div>
                <h3 className="text-lg font-semibold mb-4">EV Rentals</h3>
                <p className="text-gray-300">
                  Sustainable, convenient, and affordable electric vehicle rental solutions.
                </p>
              </div>
              <div>
            ...
            <div className="border-t border-gray-700 mt-8 pt-6 text-center text-gray-400">
              <p>© {new Date().getFullYear()} EV Rentals. All rights reserved.</p>
            </div>
          </div>
        </footer>
        <Toaster
